...
**Integrations:**
- [IDE Integration](docs/ide.md) - VS Code and other IDEs
- [GitHub Integration](docs/github.md) - GitHub features
...
├── docs/             # Optional: URL-synced documentation
└── references/       # Optional: manually added files
```
...
```json
"allow": ["mcp__server__tool_name"]
"allow": ["mcp__server__*"]  // All tools from server
```
...
- Use docs/ for detailed content
- Description must explain WHEN to use

**Agents:**
- Use focused, single-purpose agents
- Limit tool access when possible
- Include `skills:` to auto-load relevant knowledge

**Settings:**
- Use project settings for team-shared config
- Use local settings for personal overrides
- Deny dangerous commands, ask for destructive ones
