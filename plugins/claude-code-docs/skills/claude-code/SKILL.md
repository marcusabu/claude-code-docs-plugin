...
- Changelog head: **** (`docs/changelog.md`)
...
- [Plugins](docs/plugins.md), [Plugin marketplaces](docs/plugin-marketplaces.md), [Discover plugins](docs/discover-plugins.md)
