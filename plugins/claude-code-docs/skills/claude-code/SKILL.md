...
- Changelog head: **2.1.215** (`docs/changelog.md`)
...
- Safety & permissions: [Feature availability](docs/feature-availability.md), [Permission modes](docs/permission-modes.md), [Permissions](docs/permissions.md), [Sandboxing](docs/sandboxing.md), [Data usage](docs/data-usage.md), [Security](docs/security.md), [Admin setup](docs/admin-setup.md), [Accessibility](docs/accessibility.md)
...
- Surfaces & integrations: [Desktop](docs/desktop.md), [Desktop quickstart](docs/desktop-quickstart.md), [Desktop Linux](docs/desktop-linux.md), [Desktop WSL](docs/desktop-wsl.md), [Desktop scheduled tasks](docs/desktop-scheduled-tasks.md), [Mobile](docs/mobile.md), [Claude Code on the web](docs/claude-code-on-the-web.md), [Web quickstart](docs/web-quickstart.md), [Artifacts](docs/artifacts.md), [VS Code](docs/vs-code.md), [JetBrains](docs/jetbrains.md), [Slack](docs/slack.md), [Computer use](docs/computer-use.md), [Voice dictation](docs/voice-dictation.md)
- Infra & deployment: [Platforms](docs/platforms.md), [Network config](docs/network-config.md), [GitHub Actions](docs/github-actions.md), [Headless](docs/headless.md), [Gateways](docs/gateways.md), [Claude apps gateway](docs/claude-apps-gateway.md), [LLM Gateway](docs/llm-gateway.md), [LLM gateway connect](docs/llm-gateway-connect.md), [LLM gateway protocol](docs/llm-gateway-protocol.md), [LLM gateway rollout](docs/llm-gateway-rollout.md), [Corporate launcher](docs/corporate-launcher.md), [Bedrock](docs/amazon-bedrock.md), [Vertex](docs/google-vertex-ai.md), [Foundry](docs/microsoft-foundry.md)
...
- Changelog now covers releases through 2.1.215, including permission-check hardening, long-running tool heartbeats, background-session fixes, `/fork` and `/subtask`, auto-mode reset, MCP auto-backgrounding, and stream-json/OTel reliability fixes: [Changelog](docs/changelog.md)
- Week 29 highlights artifacts using each viewer's MCP connectors, screen reader mode, `/fork`, provider auto-mode changes, corporate launcher support, stream-json subagent forwarding, and session caps for WebSearch/subagents: [What's new](docs/whats-new.md), [Week 29](docs/whats-new__2026-w29.md)
- New or newly surfaced docs include accessibility, corporate launcher, Desktop WSL, mobile, goal, and the Week 29 digest: [Accessibility](docs/accessibility.md), [Corporate launcher](docs/corporate-launcher.md), [Desktop WSL](docs/desktop-wsl.md), [Mobile](docs/mobile.md), [Goal](docs/goal.md)
- Agent SDK docs include expanded TypeScript, Python, MCP, permissions, structured outputs, custom tools, session storage, file checkpointing, hosting, and agent-loop guidance: [Agent SDK TypeScript](docs/agent-sdk__typescript.md), [Python](docs/agent-sdk__python.md), [MCP](docs/agent-sdk__mcp.md), [Permissions](docs/agent-sdk__permissions.md)
- Core CLI, configuration, desktop/web, agent-view, monitoring, and deployment/provider pages changed substantially; start from the linked reference groups above before digging into individual changed files.
...
- Last synced: 2026-07-20 12:00 Europe/Amsterdam
